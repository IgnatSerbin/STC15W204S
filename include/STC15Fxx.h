...
SFR(CLK_DIV, 0x97);     //0000,0000 Clock division control register
...
SBIT(PX0, _IP, 0);
#define _IE2 0xAF
SFR(IE2, 0xAF);         //0000,0000 Interrupt Controller 2
#define _IP2 0xB5
...
SBIT(IT0, _TCON, 0);
#define _TMOD 0x89
SFR(TMOD, 0x89);        //0000,0000 T0/T1-mode depositor
#define _TL0 0x8A
...
SFR(ADC_RES, 0xBD);     //0000,0000 A/Dconversion result is 8 digits high
#define _ADC_RESL 0xBE
SFR(ADC_RESL, 0xBE);    //0000,0000 A/D conversion result is 2 digits lower
...
//To access these registers, you need to set the BIT7 of P_SW2 to 1 before you can read and write normally
